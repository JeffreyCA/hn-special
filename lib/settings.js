  ...
  if (container) {
    ...
    if (isFirstTime) {
      ...
      items.inner.children[1].innerHTML =
        "<strong>Welcome to HN Embolden!</strong> This is the settings panel. You can use it to enable or disable this extension's features. Make sure to apply the changes when you're done.";
    }
